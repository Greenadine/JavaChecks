...
public final class Checks {
    ...
    public static void check(boolean expression, @NotNull String message, Object... replacements) {
        if (!expression)
            throw new IllegalArgumentException(message.formatted(replacements));
    }
    ...
    public static void checkState(boolean expression, @NotNull String message, Object... replacements) {
        if (!expression)
            throw new IllegalStateException(message.formatted(replacements));
    }
    ...
    public static void isNotNull(Object argument, @NotNull String message, Object... replacements) {
        if (argument == null)
            throw new NullPointerException(message.formatted(replacements));
    }
    ...
    public static void isEmpty(Object argument, @NotNull String message, Object... replacements) {
        ...
        checkEmpty(argument, IllegalArgumentException::new, message.formatted(replacements));
    }
    ...
    public static void isNotEmpty(Object argument, @NotNull String message, Object... replacements) {
        isNotNull(argument, message, replacements);
        checkNotEmpty(argument, IllegalArgumentException::new, message.formatted(replacements));
    }
    ...
    private static <T extends Throwable> void checkEmpty(Object argument, Function<String, T> throwableFunction, String message) throws T {
        ...
        switch (argument) {
            case String str -> Checks.check(str.isEmpty(), throwableFunction, message);
            case Collection<?> collection -> Checks.check(collection.isEmpty(), throwableFunction, message);
            case Map<?, ?> map -> Checks.check(map.isEmpty(), throwableFunction, message);
            default -> throw throwableFunction.apply(message);
        }
    }
